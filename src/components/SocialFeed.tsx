        ...
        */}
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {placeholderPosts.map((post) => (
            <div
              key={post.id}
              className="aspect-square bg-dark-700 border border-dark-600/50 rounded-sm flex items-center justify-center group hover:border-gold-500/30 transition-colors duration-300"
            >
